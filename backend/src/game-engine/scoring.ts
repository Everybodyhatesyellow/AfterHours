import type { GameType, Player, ScoreEvent } from "../types/domain.js";

export const BASE_POINTS: Partial<Record<GameType, number>> = {
  truth: 10,
  dare: 20,
  never_have_i_ever: 5,
  most_likely_to: 5,
...
export function pointsForCompletion(
  gameType: GameType,
  intensity: "chill" | "normal" | "bold" | "wild",
  player: Player,
  doubled = false
): ScoreEvent {
...
export function pointsForSkip(): ScoreEvent | null {
