...
export const socialModePrompts: Prompt[] = [
  ...
  mode(
    ...
    "Tell the group two true things and one lie about yourself. The group gets one guess.",
    { difficulty: 2 },
  ),
  mode(
    "ttl_02",
    "two_truths_and_a_lie",
    "Make your three statements about your university life. Keep the lie believable.",
    { difficulty: 2, tags: ["social", "university"] },
  ),
  mode(
    "ttl_03",
    "two_truths_and_a_lie",
    "Make your three statements about your dating history. The group votes on the lie.",
    { difficulty: 2, tags: ["social", "relationship"] },
  ),
  mode(
    "hot_01",
    "hot_seat",
    "Everyone gets one question: what is a hill you would die on?",
  ),
  mode(
    "hot_02",
    "hot_seat",
    "Everyone gets one question: what is your most chaotic student story?",
  ),
  mode(
    "hot_03",
    "hot_seat",
    "Everyone gets one question: what is something people always misunderstand about you?",
    { difficulty: 2 },
  ),
  mode(
    "hot_04",
    "hot_seat",
    "Everyone gets one question: who would you trust to plan your perfect night?",
