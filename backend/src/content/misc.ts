...
export const hotSeatStarters: string[] = [
...
export const votePrompts: Prompt[] = [
  "Best dressed?",
...
export const randomEvents: { type: RandomEventType; label: string; description: string }[] = [
...
export const miniGames: { type: MiniGameType; label: string; description: string }[] = [
...
export const miscPrompts: Prompt[] = [...votePrompts];
