...
export const wouldYouRatherPrompts = [
    ...
    w("03", ["Date someone with no sense of humor", "Date someone with no ambition"], { tags: ["relationship"] }),
    w("04", ["Leak your search history", "Leak your camera roll"], {
        intensity: "bold",
    }),
    w("05", ["Everyone knows your salary", "Everyone knows your dating history"], { tags: ["relationship"], intensity: "bold" }),
    w("06", [
