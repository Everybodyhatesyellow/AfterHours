 ...
 */
export function pickNextGameType(room, candidates) {
 ...
 */
export function selectPrompt(room, gameType, customPool = []) {
 ...
 */
function pickBalancedPrompt(room, candidates) {
